...
import net.mcreator.elliemoreand.procedure.ProcedureRADcoolMEe;
...
public class PotionRadime extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radime")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radime")
	public static final PotionType potionType = null;
	public PotionRadime(ElementsElliemoreAND instance) {
		super(instance, 9);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radime");
			setPotionName("effect.radime");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radime.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcoolMEe.executeProcedure($_dependencies);
			}
		}
