...
import net.mcreator.elliemoreand.procedure.ProcedureRADcooldownlow2;
...
public class PotionRadi2 extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radi2")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radi2")
	public static final PotionType potionType = null;
	public PotionRadi2(ElementsElliemoreAND instance) {
		super(instance, 2);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radi2");
			setPotionName("effect.radi2");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radi2.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcooldownlow2.executeProcedure($_dependencies);
			}
		}
