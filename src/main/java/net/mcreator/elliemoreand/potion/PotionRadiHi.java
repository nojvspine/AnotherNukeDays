...
import net.mcreator.elliemoreand.procedure.ProcedureRADcoolHI;
...
public class PotionRadiHi extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radihi")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radihi")
	public static final PotionType potionType = null;
	public PotionRadiHi(ElementsElliemoreAND instance) {
		super(instance, 18);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radihi");
			setPotionName("effect.radihi");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radihi.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcoolHI.executeProcedure($_dependencies);
			}
		}
