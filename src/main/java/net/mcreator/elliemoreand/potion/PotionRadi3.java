...
import net.mcreator.elliemoreand.procedure.ProcedureRADcooldownlow3;
...
public class PotionRadi3 extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radi3")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radi3")
	public static final PotionType potionType = null;
	public PotionRadi3(ElementsElliemoreAND instance) {
		super(instance, 3);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radi3");
			setPotionName("effect.radi3");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radi3.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcooldownlow3.executeProcedure($_dependencies);
			}
		}
