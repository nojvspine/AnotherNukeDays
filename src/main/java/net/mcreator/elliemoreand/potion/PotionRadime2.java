...
import net.mcreator.elliemoreand.procedure.ProcedureRADcoolME2;
...
public class PotionRadime2 extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radime2")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radime2")
	public static final PotionType potionType = null;
	public PotionRadime2(ElementsElliemoreAND instance) {
		super(instance, 10);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radime2");
			setPotionName("effect.radime2");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radime2.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcoolME2.executeProcedure($_dependencies);
			}
		}
