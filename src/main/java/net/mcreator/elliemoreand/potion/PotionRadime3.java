...
import net.mcreator.elliemoreand.procedure.ProcedureRADcoolME3;
...
public class PotionRadime3 extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radime3")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radime3")
	public static final PotionType potionType = null;
	public PotionRadime3(ElementsElliemoreAND instance) {
		super(instance, 11);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radime3");
			setPotionName("effect.radime3");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radime3.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcoolME3.executeProcedure($_dependencies);
			}
		}
