...
import net.mcreator.elliemoreand.procedure.ProcedureRADcoolHI3;
...
public class PotionRadihi3 extends ElementsElliemoreAND.ModElement {
	@GameRegistry.ObjectHolder("anukedays:radihi3")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("anukedays:radihi3")
	public static final PotionType potionType = null;
	public PotionRadihi3(ElementsElliemoreAND instance) {
		super(instance, 20);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -103);
			setRegistryName("radihi3");
			setPotionName("effect.radihi3");
			potionIcon = new ResourceLocation("anukedays:textures/mob_effect/radihi3.png");
		}
		...
		public void removeAttributesModifiersFromEntity(EntityLivingBase entity, AbstractAttributeMap attributeMapIn, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRADcoolHI3.executeProcedure($_dependencies);
			}
		}
