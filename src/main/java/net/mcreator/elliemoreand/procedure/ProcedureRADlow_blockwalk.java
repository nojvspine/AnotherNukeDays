...
public class ProcedureRADlow_blockwalk extends ElementsElliemoreAND.ModElement {
	public ProcedureRADlow_blockwalk(ElementsElliemoreAND instance) {
		super(instance, 37);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure RADlow_blockwalk!");
			return;
		}
		...
		if ((!(((entity instanceof EntityPlayer) ? ((EntityPlayer) entity).inventory.armorInventory.get(1) : ItemStack.EMPTY)
				.getItem() == new ItemStack(ItemHazmate.legs, (int) (1)).getItem()))) {
